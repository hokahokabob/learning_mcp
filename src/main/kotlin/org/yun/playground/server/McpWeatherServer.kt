...
fun `run mcp server`() {
    println("Hey! I am McpWeatherServer.")
    ...
    println("Will instanciate a MCP server")
    ...
    println("Will add tools into the server")
    ...
    server.addTool(
        ...
        val logger = LoggerFactory.getLogger("get_forecast")
